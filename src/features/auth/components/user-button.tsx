              ...
              <div className="flex-1 whitespace-nowrap min-w-0 overflow-hidden text-ellipsis">
                <div className="flex items-center justify-start">
                  <div className="flex items-center whitespace-nowrap overflow-hidden text-ellipsis">
                    <div className="text-[#37352f] dark:text-[#ffffffcf] text-sm font-medium whitespace-nowrap overflow-hidden text-ellipsis mr-1">
                      {name}&apos;s Notion
                    </div>
  ...
  if (side === "right") {
    return (
      <UserWrapper align="end" sideOffset={16}>
        <Button variant="ghost" className="flex justify-center items-center gap-x-2 max-h-8 pl-2 pr-1 h-8 rounded-md dark:text-white">
